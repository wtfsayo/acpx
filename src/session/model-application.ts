...
export async function applyRequestedModelIfAdvertised(params: {
  ...
  // Startup-flag adapters (Devin) already received the model at process launch;
  // re-asserting through session/set_config_option can reject adapter-resolved
  // fuzzy names the flag already applied.
